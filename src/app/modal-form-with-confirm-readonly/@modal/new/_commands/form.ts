...
import { formSchema } from "@/app/modal-form-with-confirm-readonly/@modal/new/_schemas/formSchema";
...
export async function submit(formData: FormData): Promise<FormResultType> {
  ...
  if (parseData.success) {
    return redirect("/modal-form-with-confirm-readonly?success=true");
  }
